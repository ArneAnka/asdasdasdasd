    ...
    <div class="flex items-start px-0 py-4">
        ...
        <div class="">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900 -mt-1 inline-flex items-center">
            ...
            <h2><small class="text-sm text-gray-700">Inlagd {{ $collection->created_at }} ({{ $collection->created_at->diffForhumans() }})</small></h2>
            <h2 class="uppercase underline">{{$collection->topic}}</h2>
