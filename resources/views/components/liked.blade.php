<div class="p-6 border-t border-gray-200">
        ...
        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                ...
                <div>
                    * <a href="{{ route(strtolower(class_basename($like->likeable_type)). '.show', $like->likeable_id) }}" class="underline">{{ $like->likeable->topic ?? 'övrigt' }} ({{ $like->likeable->site ?? 'övrigt' }})</a>
                </div>
                @empty
